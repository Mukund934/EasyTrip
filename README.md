...
- ✅ **1,285 assertions across three layers** – 692 API tests against a real PostgreSQL, 471 component tests, and 122 browser journeys including ones that really sign in through the Firebase Auth Emulator and drive client-rendered pages as that user. Measured at Sprint 8.35, by running all three suites; reproduce with `cd backend && npm test`, `cd frontend && npm test`, `npm run test:e2e`
