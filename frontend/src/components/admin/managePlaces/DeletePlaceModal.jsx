...
/** Confirmation before a destructive delete. The page rendered this behind a
 *  `{showDeleteModal && (…)}` guard; the guard moves in here so the page reads as one line. */
export const DeletePlaceModal = ({ manage }) => {
  const { showDeleteModal, placeToDelete, deleting, setShowDeleteModal, handleDelete } = manage;
